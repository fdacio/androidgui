...
public class DeputadoEstadualListAdapter extends BaseAdapter{
	private Context context;
	private List<DeputadoEstadual> lista;
	
	public DeputadoEstadualListAdapter(Context context, List<DeputadoEstadual> lista){
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		DeputadoEstadual l = lista.get(position);
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view1 = inflater.inflate(R.layout.deputado_estadual_linha_adapter, null);
