...
public class GovernadorListAdapter extends BaseAdapter{
	private Context context;
	private List<Governador> lista;
	
	public GovernadorListAdapter(Context context, List<Governador> lista){
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		Governador g = lista.get(position);
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view1 = inflater.inflate(R.layout.governador_linha_adapter, null);
