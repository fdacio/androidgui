...
public class PartidosListAdapter extends BaseAdapter {
    private Context context;
    private List<Partidos> lista;

    public PartidosListAdapter(Context context, List<Partidos> lista) {
	...
	Partidos l = lista.get(position);
	LayoutInflater inflater = (LayoutInflater) context
		.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	View view1 = inflater.inflate(R.layout.partidos_linha_adapter, null);
