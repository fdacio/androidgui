...
public class PresidenteVotacaoListAdapter extends BaseAdapter{
	private Context context;
	private List<Presidente> lista;
	
	public PresidenteVotacaoListAdapter(Context context, List<Presidente> lista){
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		Presidente l = lista.get(position);
