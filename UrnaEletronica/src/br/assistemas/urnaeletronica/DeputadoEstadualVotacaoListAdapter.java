...
public class DeputadoEstadualVotacaoListAdapter extends BaseAdapter{
	private Context context;
	private List<DeputadoEstadual> lista;
	
	public DeputadoEstadualVotacaoListAdapter(Context context, List<DeputadoEstadual> lista){
