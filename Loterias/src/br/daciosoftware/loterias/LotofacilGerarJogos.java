...
public class LotofacilGerarJogos extends Activity {
	protected static final String CATEGORIA = "loterias";
	private static final int DIRECTORY_BROWSER = 1;
	private static final String NOME_ARQUIVO = "jogos_lotofacil.txt";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gerar_jogos_lotofacil);
        ...
        btGerarJogos.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				...
				if(qtdeDezenas > listaDezenasSelecionadas.size()){
					Toast.makeText(LotofacilGerarJogos.this, "Erro! Quantidade "+spinnerConcursos.getSelectedItem().toString()+" maior que dezenas selecionadas", Toast.LENGTH_SHORT).show();
				}
				else{
					dialog = ProgressDialog.show(LotofacilGerarJogos.this, "", "Aguarde...",false,true);
					carregaJogos();
				}
			}
		});
       	...
       	btSalvarJogosTxt.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				Intent it = new Intent(LotofacilGerarJogos.this, FileDialog.class);
	...
	protected void atualizaListaJogos(){
		...
		LotofacilJogosGeradosListAdapter adapter = new LotofacilJogosGeradosListAdapter(this,listaJogosGerados);
	...
	protected void montaArquivo(String directoryFile, String nomeArquivo){
		...
		try {
			...
			out.close();
			Toast.makeText(LotofacilGerarJogos.this, "Arquivo: "+directoryFile+"/"+nomeArquivo +" salvo com sucesso", Toast.LENGTH_SHORT).show();
