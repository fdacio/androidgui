...
public class MegasenaMaisSorteadas {
	private long id;
	private int dezena;
	...
	public static String[] colunas = new String[]{MegasenaMaisSorteadasColunas._ID, 
		MegasenaMaisSorteadasColunas.DEZENA,
		MegasenaMaisSorteadasColunas.FREQUENCIA,
		MegasenaMaisSorteadasColunas.SELECIONADA};

	public MegasenaMaisSorteadas(){
	 ...
	 *
	 */
	public static final class MegasenaMaisSorteadasColunas implements BaseColumns{
		//Não pode estanciar essa classe
		private MegasenaMaisSorteadasColunas(){
