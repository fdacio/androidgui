...
public class LotofacilMaisSorteadas {
	private long id;
	private int dezena;
	...
	public static String[] colunas = new String[]{LotofacilMaisSorteadasColunas._ID, 
		LotofacilMaisSorteadasColunas.DEZENA,
		LotofacilMaisSorteadasColunas.FREQUENCIA,
		LotofacilMaisSorteadasColunas.SELECIONADA};

	public LotofacilMaisSorteadas(){
	 ...
	 *
	 */
	public static final class LotofacilMaisSorteadasColunas implements BaseColumns{
		//Não pode estanciar essa classe
		private LotofacilMaisSorteadasColunas(){
