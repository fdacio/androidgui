...
public class QuinaListAdapter extends BaseAdapter{
	private Context context;
	private List<Quina> lista;
	
	public QuinaListAdapter(Context context, List<Quina> lista){
