...
public class MegasenaMenu extends Activity implements OnItemClickListener{
	...
	public void onCreate(Bundle icicle){
		...
		MenuAdapter adapter = new MenuAdapter(this,itensMenu,R.drawable.icon_megasena);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		switch(position){
		case 0:
			startActivity(new Intent(this, MegasenaCarregarArquivo.class));			
			break;
		case 1:
			startActivity(new Intent(this, MegasenaDezenasMaisSorteadas.class));
			break;
		case 2:
			startActivity(new Intent(this, MegasenaListagemResultados.class));
			break;
		default:
