...
public class FileDialog extends ListActivity {
    ...
    /**
     * Parametro de entrada da Activity: se é somente para seleção de diretorios
     * onde deve salvar arquivo. Padrao: falso.
     */
    ...
    private String startPath = START_PATH;
	 ...
	 * newButton.setOnClickListener(new OnClickListener() { public void
	 * onClick(View v) { setCreateVisible(v); mFileName.setText("");
	 * mFileName.requestFocus(); } });
	 * 
	 * selectionMode =
	 * getIntent().getIntExtra(SELECTION_MODE,FileSelectionMode.MODE_OPEN);
	 * if (selectionMode == FileSelectionMode.MODE_OPEN) {
	 ...
	 * onClick(View v) { setSelectVisible(v); } }); final Button
	 * createButton = (Button) findViewById(R.id.fdButtonCreate);
	 * createButton.setOnClickListener(new OnClickListener() { public void
	 * onClick(View v) { if (mFileName.getText().length() > 0) {
	 * getIntent().putExtra(RESULT_PATH, currentPath + "/" +
	 * mFileName.getText()); setResult(RESULT_OK, getIntent()); finish(); }
	 * } });
	 */
